...
<script src="/nm/static/js/mobile.js"></script>
...
<div class="worry01 btn1"></div>
    <div class="popup_bg pop01"><p style="font-size:48px;color:#fff;">X</p>
        <div class="popup">
            <iframe src="./black_service_worry01.php" style="width:100%; height:100%;z-index:99999;"></iframe>
        </div>
    </div>
    
    <div class="worry02 btn2"></div>
    <div class="popup_bg pop02"><p style="font-size:48px;color:#fff;">X</p>
        <div class="popup_style">
            <iframe src="./black_service_worry02.php" style="width:100%; height:100%;z-index:9999"></iframe>
        </div>
    </div>
    </div>
    <div class="worry03 btn3"></div>
    <div class="popup_bg pop03"><p style="font-size:48px;color:#fff;">X</p>
        <div class="popup_style">
            <iframe src="./black_service_worry03.php" style="width:100%; height:100%;z-index:9999"></iframe>
        </div>
    </div>  <!-- 1900↑ mobilepage => webpage redirect start -->
  <script>
    if ($(window).width() > 1900) {
      $.getScript('js/nbw-parallax.js');
    }
    if (window.innerWidth > 1900) {
      window.location.href = 'https://www.isoohyun.co.kr/new/service/new_black_service.php?mctkey=';
    }
  </script>
  <!-- 1900↑ mobilepage => webpage redirect end -->
  <link href="https://cdn.rawgit.com/mdehoog/Semantic-UI/6e6d051d47b598ebab05857545f242caf2b4b48c/dist/semantic.min.css" rel="stylesheet" type="text/css" />
  <link rel="stylesheet" href="black_service.css">
...
<body bgproperties="fixed" style="max-width:400px;margin:0 auto;">
  <div class="wrap">
    <!-- Link Swiper's CSS -->
...
<!-- 러브테스트만 더보기 추가 함 2022.02.11 -->
  ...
  <h2 class="title">
      ...
      <div class="location">
	<a href="/nm/html/main/index.php"><i class="ico-home">홈으로</i></a><a href="/nm/html/benefit/join-info01.php">가입문의</a><a href="/nm/html/service/black_service.php">블랙서비스</a></div>
      <section class="contents">
        <!-- section01 -->
        <div class="parent_content" style="width: 100%;">
          <img src="../../static/images/black_service/black_service_m_title.jpg">
        </div>
        <!-- section02 -->
        <div class="parent_content" id="parent_motion01">
          <img style="width: 100%;" src="../../static/images/black_service/mobile02.jpg">
          <div class="child_content2" id="black_members_motion01">
            <img src="" alt="">
          </div>
        </div>
        <!-- section03 -->
        <div class="parent_content" class="parent_content">
          <div class="img_content"><img style="width: 100%;" src="../../static/images/black_service/3.jpg"></div>

        </div>
        <!-- section04 -->
        <div class="parent_content" id="parent_motion02">
          <img style="width: 100%;" src="../../static/images/black_service/mobile04.jpg">
          <div class="child_content4" id="black_members_motion02">
            <img src="" alt="">
          </div>
        </div>
        <!-- 박스 이미지 -->
        <div class="child_content4_5">
          <img src="../image/black_service/04_1.jpg" alt="">
        </div>
        <!-- section05 -->
        <div class="parent_content" id="parent_motion03">
          <img style="width: 100%;" src="../../static/images/black_service/mobile05.jpg">
          <div class="child_content5" id="black_members_motion03">
            <img src="" alt="">
          </div>
        </div>
        <!-- section06 -->
        <div class="parent_content">
          <img style="width: 100%;" src="../../static/images/black_service/6_bgimg.jpg">
          <div class="child_content6">
            <div class="slide" style="margin-top:-20px;">
              <ul style="">
                <li><img src="../../static/images/black_service/06_2.jpg" alt="" /></li>
                <li><img src="../../static/images/black_service/6_1.jpg" alt="" /></li>
                <li><img src="../../static/images/black_service/6_2.jpg" alt="" /></li>
                <li><img src="../../static/images/black_service/6_3.jpg" alt="" /></li>
                <li><img src="../../static/images/black_service/6_4.jpg" alt="" /></li>
                <li><img src="../../static/images/black_service/6_5.jpg" alt="" /></li>
                <li><img src="../../static/images/black_service/6_6.jpg" alt="" /></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="parent_contents">
          <img style="width: 100%;" src="../../static/images/black_service/7.jpg">
          <div class="child_content7">
          </div>
        </div>
        <!-- section08 -->
        <div class="parent_content">
          <img style="width: 100%;" src="../../static/images/black_service/8.jpg">
          <div class="child_content8">
          </div>
        </div>
        <!-- section09 -->
        <div class="parent_content" id="">
          <img style="width: 100%;" src="../../static/images/black_service/9.jpg">
          <div class="child_content9" style="margin-top:-245px;">
            <a href="https://m.isoohyun.co.kr/nm/html/meet/premium-culture.php?counselGbn=27603"><img style="width: 70%;margin-left:30px" src="../../static/images/black_service/9_1.jpg"></a>
            <a href="https://m.isoohyun.co.kr/nm/html/meet/premium-christian.php?counselGbn=27602"><img style="width: 70%;margin-left:10px;margin-right:10px" src="../../static/images/black_service/9_2.jpg"></a>
            <a href="https://m.isoohyun.co.kr/nm/html/meet/premium-golf.php?counselGbn=27601"><img style="width: 70%;margin-right:30px" src="../../static/images/black_service/9_3.jpg"></a>
          </div>

        </div>
        <!-- section10 -->
        <div class="parent_content10">
          <img style="width: 100%;" src="../../static/images/black_service/10.jpg">
          <!-- 고민1 start -->
          <div style="text-align:center;">
            <a class="child_content10 btn1" id="pop" style="cursor: pointer;"><img class="btn1" src="../../static/images/black_service/10_1.png" alt=""></a>
          </div>
          <!-- 고민2 start -->
          <div style="text-align:center;">
            <a class="child_content10 btn2" id="pop2" style="cursor: pointer;"><img class="btn2" src="../../static/images/black_service/10_22.png" alt=""></a>
          </div>
          <!-- 고민3 start -->
          <div style="text-align:center;">
            <a class="child_content10 btn3" id="pop3" style="cursor: pointer;"><img class="btn3" src="../../static/images/black_service/10_3.png" alt=""></a>
          </div>
          <div style="background-color:#fff;">
            <img style="height: 100px;width:100%;background-size: 10%;background-position: bottom;" src="../../static/images/black_service/11bg.jpg">
          </div>
        </div>
