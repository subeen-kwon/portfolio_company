...
.full4 {
  background-image: url(https://www.isoohyun.co.kr/new/image/new_main/sec5.jpg);
  background-size: cover;
  justify-content: space-between;
}
.full4::before {
...
/* content 4 癲ル슢�욑옙��닱占쎄퀣�뺟넭怨λ짋占쏙옙 */

.content4_artwrap {
}

/* section 5 占쎌쥙�∽옙�먯삕嚥〓끃�뺧옙醫묒삕 */
.full5 {
}
...
/* section 9 占쎌쥙�ο옙�낆삕筌믩끃�뺝뜝�덈깽占썩뮪�앾옙�덉굲 */
.full9 h5 {
}
...
.event2_btn {
  background-image: url(https://www.isoohyun.co.kr/new/image/new_main/event_btn.png);
  background-size: contain;
}
.event2_btn:hover{
  background-image: url(https://www.isoohyun.co.kr/new/image/new_main/event_btn_hover.png);
  background-size: contain;
}
...
/* content 11 占쎌쥙�э옙���뱄옙醫롫윥占쏙퐦�숋옙瑜곸굲占쎌쥜�� */
.content11_header {
  padding-top: 19vh;
  text-align: center;
}
...
/* content 6 占쎌쥙�ο옙節륁삕占쎌뼚�뺟넭怨κ덱占쏙옙 */
...
<div id="body" style="opacity: 0; transition: all 500ms ease-in;">
  <aside class="t-flex t-fixed t-w-full t-bottom-0 t-left-0 sm:t-mb-10 t-hidden sm:t-block">
    <ul class="t-flex t-justify-between t-items-center t-w-full sm:t-w-[1008px] t-text-xs md:t-text-[22px] md:t-leading-[23px] sm:t-mx-auto t-text-cg t-font-bold sm:t-gap-5">
      <a href="javascript:modalOpen('speed0')" class="t-text-center t-flex-1 sm:t-flex-0 t-bg-white hover:t-text-white hover:t-bg-red sm:t-drop-shadow-md t-py-3 t-px-2 sm:t-px-6 sm:t-rounded-[50px] t-duration-300">
        <li>자주하는 질문</li>
      </a>
      <a href="javascript:modalOpen('speed1')" class="t-text-center t-flex-1 sm:t-flex-0 t-bg-white hover:t-text-white hover:t-bg-red sm:t-drop-shadow-md t-py-3 t-px-2 sm:t-px-6 sm:t-rounded-[50px] t-duration-300">
        <li>방문예약</li>
      </a>
      <a href="javascript:modalOpen('speed2')" class="t-text-center t-flex-1 sm:t-flex-0 t-bg-white hover:t-text-white hover:t-bg-red sm:t-drop-shadow-md t-py-3 t-px-2 sm:t-px-6 sm:t-rounded-[50px] t-duration-300">
        <li>무료상담</li>
      </a>
      <a href="javascript:modalOpen('speed3')" class="t-text-center t-flex-1 sm:t-flex-0 t-bg-white hover:t-text-white hover:t-bg-red sm:t-drop-shadow-md t-py-3 t-px-2 sm:t-px-6 sm:t-rounded-[50px] t-duration-300">
        <li>가입비안내</li>
      </a>
      <a href="javascript:modalOpen('speed4')" class="t-text-center t-flex-1 sm:t-flex-0 t-bg-white hover:t-text-white hover:t-bg-red sm:t-drop-shadow-md t-py-3 t-px-2 sm:t-px-6 sm:t-rounded-[50px] t-duration-300">
        <li>안내자료</li>
      </a>
    </ul>
  </aside>
  ...
  <aside class="t-flex t-fixed t-w-full t-bottom-0 t-left-0 sm:t-mb-6 t-block sm:t-hidden ">
    <ul class="t-flex t-justify-between t-items-center t-w-full sm:t-w-[640px] t-text-xs md:t-text-base sm:t-mx-auto t-text-white t-font-bold md:t-gap-3">
      <a href="javascript:modalOpen('speed0')" class="t-text-center t-flex-1 sm:t-flex-0 t-bg-[#134276] hover:t-text-white hover:t-bg-red sm:t-drop-shadow-md t-py-3 t-px-2 sm:t-px-4 sm:t-rounded-[50px]">
        <li>자주하는 질문</li>
      </a>
      <a href="javascript:modalOpen('speed1')" class="t-text-center t-flex-1 sm:t-flex-0 t-bg-[#c7af97] hover:t-text-white hover:t-bg-red sm:t-drop-shadow-md t-py-3 t-px-2 sm:t-px-4 sm:t-rounded-[50px]">
        <li>방문예약</li>
      </a>
      <a href="javascript:modalOpen('speed2')" class="t-text-center t-flex-1 sm:t-flex-0 t-bg-[#b61211] hover:t-text-white hover:t-bg-red sm:t-drop-shadow-md t-py-3 t-px-2 sm:t-px-4 sm:t-rounded-[50px]">
        <li>무료상담</li>
      </a>
      <a href="javascript:modalOpen('speed4')" class="t-text-center t-flex-1 sm:t-flex-0 t-bg-[#bb9368] hover:t-text-white hover:t-bg-red sm:t-drop-shadow-md t-py-3 t-px-2 sm:t-px-4 sm:t-rounded-[50px]">
        <li>안내자료</li>
      </a>
    </ul>
  </aside>
  ...
  <div class="sidebar_menu">
    <div class="t-flex t-text-sm t-py-4 t-px-3 t-gap-4 t-justify-start t-items-center t-relative">
      <span><a href="https://www.isoohyun.co.kr/nm/html/login/login.php" class="btn-login">로그인</a></span>
    ...
    <div class="t-flex t-justify-between t-w-full t-h-full t-items-start">
  ...
  <header>
    <div id="mheader_section" class="t-flex xl:t-hidden t-flex t-items-center t-h-full">
  ...
  <!-- 흑백 배경 팝업 -->
  <div id="maskz2" style="cursor: pointer;width: 100%; height: 4170px; left: 0px; top:0px; opacity: 0.8; display: block; display:none;position: fixed;z-index: 102;background: #000;" alt="닫기" title="닫기"></div>
  <!-- 흑백 배경 팝업 -->

  <!-- 자주하는질문 -->
  <div id="speed0" style="display:none; z-index:10003; position: fixed; left:50%; top:50%; transform:translate(-50%, -50%);" class="t-w-[946px] t-h-[711px]">
    <iframe src="https://www.isoohyun.co.kr/new/common/new_aside_bar0.php" scrolling="no" style="width: 100%; height: 100%;" frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no vspace=0></iframe>
  </div>

  <!-- 방문예약 -->
  <div id="speed1" style="display:none; z-index:10003; position: fixed; left:50%; top:50%; transform:translate(-50%, -50%);" class="t-w-[946px] t-h-[711px]">
    <iframe src="https://www.isoohyun.co.kr/new/common/new_aside_bar1.php" scrolling="no" style="width: 100%; height: 100%;" frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no vspace=0></iframe>
  </div>

  <!-- 무료상담 -->
  <div id="speed2" style="display:none; z-index:10003; position: fixed; left:50%; top:50%; transform:translate(-50%, -50%);" class="t-w-[946px] t-h-[711px]">
    <iframe src="https://www.isoohyun.co.kr/new/common/new_aside_bar3.php" scrolling="no" style="width: 100%; height: 100%;" frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no vspace=0></iframe>
  </div>


  <!-- 가입비안내 -->
  <div id="speed3" style="display:none; z-index:10003; position: fixed; left:50%; top:50%; transform:translate(-50%, -50%);" class="t-w-[946px] t-h-[711px]">
    <iframe src="https://www.isoohyun.co.kr/new/common/new_aside_bar2.php" scrolling="no" style="width: 100%; height: 100%;" frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no vspace=0></iframe>
  </div>

  <!-- 안내자료 -->
  <div id="speed4" style="display:none; z-index:10003; position: fixed; left:50%; top:50%; transform:translate(-50%, -50%);" class="t-w-[946px] t-h-[711px]">
    <iframe src="https://www.isoohyun.co.kr/new/common/new_aside_bar4.php" scrolling="no" style="width: 100%; height: 100%;" frameborder=0 framespacing=0 marginheight=0 marginwidth=0 scrolling=no vspace=0></iframe>
  </div>
  ...
  <div id="fullpage">
    <div class="section full1 t-flex t-overflow-hidden" id="page-1" data-font-color="#fff">
      <video id="page-1-video" class="t-hidden sm:t-block" poster="https://www.isoohyun.co.kr/new/image/new_main/sec5.jpg" loop autoplay muted data-keepplaying playsinline name="media">
        <source src="/new/image/new_main/8_v2.mp4" type="video/mp4"><source/>
      </video>

      <video id="page-1-video" class="t-block sm:t-hidden" poster="https://www.isoohyun.co.kr/new/image/new_main/sec5.jpg" loop autoplay muted data-keepplaying playsinline name="media">
        <source src="/new/image/new_main/8_v2_m.mp4" type="video/mp4"><source/>
      </video>

      <script>
        const video = document.getElementById('page-1-video');
    ...
    <div class="section full2" id="page-2" data-font-color="#fff">
      <div class="t-flex t-flex-col t-h-full t-justify-center t-items-center f-main t-pb-[26px] sm:t-pb-[85px]">
        <div class="t-flex t-flex-col t-text-xl xl:t-text-4xl t-items-center t-justify-center t-gap-4 t-w-full t-h-80 xl:t-h-fit">
          <div class="xl:t-leading-[3rem] -t-tracking-[1px] t-text-white">노블레스 수현은 안정적인 회원수와 <br>
            균형있는 성비로 <span class="t-font-bold">폭넓은 만남을 제공</span>합니다.
          </div>
      ...
      <div class="t-flex t-flex-col t-justify-center t-relativet-py-6 t-h-full">
        ...
        <div class="t-flex t-flex-col t-w-full t-relative t-h-full">
          <div class="t-flex t-flex-col t-items-center t-w-full t-h-full">
            <div class="t-relative t-flex t-flex-col xl:t-flex-row t-w-full t-text-white t-h-full t-items-center t-justify-start">


              <div class="t-flex t-flex-col t-justify-center t-items-center t-w-full xl:t-w-4/12 t-relative t-bg-c1 t-p-6 t-h-80 xl:t-h-full">
                <!-- <div class="sm:t-text-xl t-text-sm t-px-10">
                  <img src="/new/image/new_main/sec3_emoji.png" class="t-inline-block t-align-middle t-w-8 t-h-8">
                  <span class="t-align-middle t-ml-2">나에게 맞는</span>
                </div> -->

                <h2 class="t-flex t-flex-col t-justify-start sm:t-text-5xl t-text-xl t-font-bold t-gap-2">
                  <span class="">나에게 맞는</span>
                  <span class="t-pb-2 sm:t-pb-6">노블레스 수현 <span class="t-text-cg">서비스</span></span>
                  
                  <span class="t-text-base sm:t-text-xl">직업,학력,소득 수준등의 경제적 조건과 함께 성향,가치관,취향 등을 종합적으로 고려한 맞춤 상대를 소개합니다.</span>
                  <a href="https://www.isoohyun.co.kr/new/lovetest/join_test.php?couselGbn=34644" target="_blank" class="t-text-xl t-text-white t-underline t-underline-offset-8 t-mt-4 sm:t-mt-10">나의 가입비 확인하기 &gt;</a>
                </h2>
              </div>

              <div class="t-flex t-flex-col t-items-start sm:t-items-center t-justify-center xl:t-w-8/12 t-flex-1 f-main t-p-[5px] xl:t-p-[10px]">
                <div class="t-flex t-flex-wrap t-w-full t-justify-between page-3-tabs">
                  
                  <div class="page-3-tab t-cursor-pointer t-gap-[5px] t-transform t-transition t-duration-500 t-bg-white hover:t-bg-[#a64041] t-text-black hover:t-text-white t-flex t-flex-col t-justify-center t-items-center hover:t-z-[100] on"  onclick="location.href='/new/benefit/benefit04.php'">
                    <div class="t-flex t-flex-col t-justify-center t-items-center t-text-xl xl:t-text-4xl t-font-bold">
                      <span>노블레스</span>
                      <div>초혼</div>
                    </div>
                    <div class="xl:t-text-xl t-font-thin">미혼남녀를 위한 서비스</div>
                    <div class="t-animate-bounce t-mt-1 md:t-mt-10 t-bg-white t-p-2 t-w-10 t-h-10 t-ring-1 t-ring-slate-900/5 t-shadow-lg t-rounded-full t-flex t-items-center t-justify-center">
                  ...
                  <div class="page-3-tab t-cursor-pointer t-gap-[5px] t-transform t-transition t-duration-500 t-bg-white hover:t-bg-[#a64041] t-text-black hover:t-text-white t-flex t-flex-col t-justify-center t-items-center hover:t-z-[100] on-side"  onclick="location.href='/new/benefit/benefit05.php'">
                    <div class="t-flex t-flex-col t-justify-center t-items-center t-text-xl xl:t-text-3xl t-font-bold">
                      <span>노블레스</span>
                      <div>재혼</div>
                    </div>
                    <div class="xl:t-text-xl t-font-thin">차별화된 재혼 서비스</div>
                    <div class="t-animate-bounce t-mt-1 md:t-mt-10 t-bg-white t-p-2 t-w-10 t-h-10 t-ring-1 t-ring-slate-900/5 t-shadow-lg t-rounded-full t-flex t-items-center t-justify-center">
                      <svg class="t-w-6 t-h-6 t-text-[#a64041]" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path d="M19 14l-7 7m0 0l-7-7m7 7V3"></path>
                      </svg>
                  ...
                  <div class="page-3-tab t-cursor-pointer t-gap-[5px] t-transform t-transition t-duration-500 t-bg-white hover:t-bg-[#a64041] t-text-black hover:t-text-white t-flex t-flex-col t-justify-center t-items-center hover:t-z-[100]"  onclick="location.href='/new/service/new_black_service.php'">
                    <div class="t-flex t-flex-col t-justify-center t-items-center t-text-xl xl:t-text-3xl t-font-bold">
                      <div>블랙서비스</div>
                    </div>
                    <div class="xl:t-text-xl t-font-thin">대한민국 상위 1% 혼맥서비스</div>
                    <div class="t-animate-bounce t-mt-1 md:t-mt-10 t-bg-white t-p-2 t-w-10 t-h-10 t-ring-1 t-ring-slate-900/5 t-shadow-lg t-rounded-full t-flex t-items-center t-justify-center">
                      <svg class="t-w-6 t-h-6 t-text-[#a64041]" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path d="M19 14l-7 7m0 0l-7-7m7 7V3"></path>
                      </svg>
                  ...
                  <div class="page-3-tab t-cursor-pointer t-gap-[5px] t-transform t-transition t-duration-500 t-bg-white hover:t-bg-[#a64041] t-text-black hover:t-text-white t-flex t-flex-col t-justify-center t-items-center hover:t-z-[100]"  onclick="location.href='/new/service/service09.php'">
                    <div class="t-flex t-flex-col t-justify-center t-items-center t-text-xl xl:t-text-3xl t-font-bold">
                      <div>자녀결혼</div>
                    </div>
                    <div class="xl:t-text-xl t-font-thin">자녀결혼 전문컨설팅</div>
                    <div class="t-animate-bounce t-mt-1 md:t-mt-10 t-bg-white t-p-2 t-w-10 t-h-10 t-ring-1 t-ring-slate-900/5 t-shadow-lg t-rounded-full t-flex t-items-center t-justify-center">
                      <svg class="t-w-6 t-h-6 t-text-[#a64041]" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path d="M19 14l-7 7m0 0l-7-7m7 7V3"></path>
                      </svg>
            ...
            <style>
              .page-3-tab {
                ...
                height: 15rem;
                overflow: hidden;
                -webkit-box-shadow: 20px 20px 40px rgb(0 0 0 / 5%);
                box-shadow: 20px 20px 40px rgb(0 0 0 / 5%);
              }
              .page-3-tab:nth-child(1),
              .page-3-tab:nth-child(2) {
                margin: 0 0 2rem 0;
              }
              .page-3-tab.on-side {
                width: 30%;
    ...
    <!-- 5.성혼율 -->
    <div class="section full4 " id="page-4"" data-font-color="#fff">
      <div class="t-flex t-flex-col t-justify-center t-items-center t-gap-10 f-main t-pb-[26px] sm:t-pb-[85px] t-px-2">
        <h5 class="t-text-base xl:t-text-xl t-text-black t-bg-white t-rounded-lg t-py-3 t-px-6 t-w-fit">노블레스 결.정.사의 <span class="t-text-red t-font-bold">수준이 다른 성혼율</span>을 확인하세요</h5>
        <div class="t-flex t-flex-col t-justify-center">
          <h3 class="t-flex t-justify-between t-text-2xl sm:t-text-6xl t-text-white">
            전문직 회원 성혼율 <span class="t-w-[150px] t-text-center t-text-cg t-font-bold page-4-1">84.4%</span>
          </h3>
        </div>
        <h4 class="t-text-white t-text-lg xl:t-text-2xl">전문직 기준 : 의사,판검사,변호사 외 11개 직종</h4>
        <a href="https://www.isoohyun.co.kr/new/benefit/benefit15.php" target="_blank" class="t-text-white t-underline t-underline-offset-8">자세히 보기 ></a>
      </div>
    </div>
        ...
        <div class="t-relative t-flex t-flex-col xl:t-flex-row t-w-full t-h-full t-text-white t-h-full">
          <div class="t-flex t-flex-col t-justify-center t-items-center t-w-full xl:t-w-4/12 t-relative t-bg-c3 t-h-80 xl:t-h-full">
            <h2 class="t-flex t-flex-col t-justify-start sm:t-text-5xl t-text-xl t-font-bold">
              <span class="t-pb-6"><span class="t-text-cg">결혼</span>할 수 있을까요?</span>
              <span class="t-text-xl">노블레스 수현은 대답합니다.</span>
              <span class="t-text-xl t-text-cg">"저 오늘도 청접장 받았어요."</span>
              <a href="https://www.isoohyun.co.kr/new/about/about15.php" target="_blank" class="t-text-xl t-text-white t-underline t-underline-offset-8 t-mt-10">매칭후기 더보기 &gt;</a>
            </h2>
          </div>
    ...
    <div class="section full6 t-flex t-flex-col" id="page-6" data-font-color="black">
      <div class="t-h-full t-flex t-flex-col t-justify-center t-items-center f-main t-pb-[26px] sm:t-pb-[85px]">
        <div class="t-flex t-flex-col t-justify-center t-items-center t-gap-4 t-w-full">
          <h5 class="t-text-black t-text-2xl xl:t-text-5xl">노블레스 수현 <span class="t-text-red t-font-bold">회원 현황</span></h5>
          <h3 class="t-text-sm xl:t-text-2xl t-text-white t-bg-c1 t-rounded-lg t-py-3 t-px-6 t-w-11/12 xl:t-w-fit">이유있는 성혼율, 노블레스 결.정.사의 가치는 <span class="t-font-bold">회원수준</span>으로 증명됩니다.</h3>
          <div class="t-h-10 t-border t-border-c1 t-hidden md:t-block"></div>
          <p class="t-text-3xl">회원수 <span class="t-text-red t-font-bold">13,168</span>명</p>
        </div>

        <div class="t-flex t-items-start t-justify-start t-bg-c1 t-text-white xl:t-px-20 t-mt-20">
          <div class="md:t-flex t-justify-between t-hidden t-border t-border-gray-600 t-rounded">
            <div class="t-w-2/12 t-flex t-justify-center t-items-center">
              <img src="https://www.isoohyun.co.kr/new/image/new_main/job01.jpg" class="t--mt-16 t-rounded page-6-tabs-img-1" />
            </div>

            <div class="t-w-3/12 t-flex t-flex-col t-justify-center t-items-center t-gap-10">
              <img src="/new/image/new_main/man.png" />
              <div class="t-text-3xl t-text-white t-font-bold"><span class="t-text-5xl t-text-cg">1</span>위</div>
              <div class="text-xl md:t-text-2xl xl:t-text-3xl t-text-white page-6-tabs-content-1">의사 / 약사</div>
            </div>

            <div class="t-w-[120px] t-grid t-grid-rows-3 t-grid-flow-col t-border-l t-border-r t-border-gray-600 page-6-tabs">
              <div class="t-flex t-justify-center t-items-center t-text-base t-border-b t-border-gray-600 t-font-bold t-py-2 hover:t-bg-cg page-6-tab t-bg-cg t-cursor-pointer" data-text="의사/약사|공무원/공기업" data-img="job01.jpg|job02.jpg">직업 비율</div>
              <div class="t-flex t-justify-center t-items-center t-text-base t-border-b t-border-gray-600 t-font-bold t-py-2 hover:t-bg-cg page-6-tab t-cursor-pointer" data-text="대학(4년제)졸업|대학(4년제)졸업" data-img="school01.jpg|school02.jpg">학력 비율</div>
              <div class="t-flex t-justify-center t-items-center t-text-base t-font-bold t-py-2 hover:t-bg-cg page-6-tab t-cursor-pointer" data-text="34세~39세|27세~33세" data-img="age01.jpg|age02.jpg">나이 비율</div>
            </div>

            <div class="t-w-3/12 t-flex t-flex t-flex-col t-justify-center t-items-center t-gap-10">
              <img src="/new/image/new_main/woman.png" />
              <div class="t-text-3xl t-text-white t-font-bold"><span class="t-text-5xl t-text-cg">1</span>위</div>
              <div class="text-xl md:t-text-2xl xl:t-text-3xl t-text-white page-6-tabs-content-2">공무원 / 공기업</div>
            </div>

            <div class="t-w-2/12 t-flex t-justify-center t-items-center">
              <img src="https://www.isoohyun.co.kr/new/image/new_main/job02.jpg" class="t--mt-16 t-rounded page-6-tabs-img-2" />
            </div>
          </div>

          

          <div class="t-flex t-flex-col md:t-hidden">
            <div class="t-flex t-items-start t-justify-between t-w-full page-6-tabs">
              <div class="t-w-full t-grid t-grid-cols-3 t-border t-border-gray-600">
              <div class="t-flex t-justify-center t-items-center t-text-base t-font-bold t-py-2 hover:t-bg-cg page-6-tab t-bg-cg t-cursor-pointer" data-text="의사/약사|공무원/공기업">직업 비율</div>
              <div class="t-flex t-justify-center t-items-center t-text-base t-border-l t-border-gray-600 t-font-bold t-py-2 hover:t-bg-cg page-6-tab t-cursor-pointer" data-text="대학(4년제)졸업|대학(4년제)졸업">학력 비율</div>
              <div class="t-flex t-justify-center t-items-center t-text-base t-border-l t-border-gray-600 t-font-bold t-py-2 hover:t-bg-cg page-6-tab t-cursor-pointer" data-text="34세~39세|27세~33세">나이 비율</div>
              </div>
            </div>

            <div class="t-flex t-items-center t-justify-between t-w-full t-p-2 t-gap-2 t-border-b t-border-gray-600">
              <div class="t-w-5/12 t-flex t-flex-col t-justify-center t-items-center t-flex-1 t-relative">
                
                <img src="/new/image/new_main/man.png" />
                <img src="https://www.isoohyun.co.kr/new/image/new_main/job01.jpg" class="t-rounded page-6-tabs-img-1" />

                <div class="t-absolute t-bottom-0 t-w-full t-flex t-justify-center t-items-end t-gap-2 t-py-2 t-bg-[#00000096]">
                  <div class="t-text-xl t-font-bold t-text-white page-6-tabs-content-1">공무원 / 공기업</div>
                </div>
              </div>

              <div class="t-w-2/12 t-flex t-items-center t-justify-center">
                <div class="t-text-2xl t-text-white t-font-bold"><span class="t-text-3xl t-text-cg">1</span>위</div>
              </div>

              <div class="t-w-5/12 t-flex t-flex-col t-justify-center t-items-center t-flex-1 t-relative">
                
                <img src="/new/image/new_main/woman.png" />
                <img src="https://www.isoohyun.co.kr/new/image/new_main/job02.jpg" class="t-rounded page-6-tabs-img-2" />

                <div class="t-absolute t-bottom-0 t-w-full t-flex t-justify-center t-items-end t-gap-2 t-py-2 t-bg-[#00000096]">
                  <div class="t-text-xl t-font-bold t-text-white page-6-tabs-content-2">공무원 / 공기업</div>
                </div>
              </div>
              <script>
                $(document).ready(function() {
                  $('.page-6-tab').click(function() {
                    $('.page-6-tab').removeClass('t-bg-cg');
                    var idx = $('.page-6-tab').index(this) % 3;
                    
                    $('.page-6-tab').eq(idx).addClass('t-bg-cg');
                    ...
                    $('.page-6-tabs-img-1').attr('src','/new/image/new_main/' + tab_imgs[0]);
                    $('.page-6-tabs-img-2').attr('src','/new/image/new_main/' + tab_imgs[1]);
                  });
    ...
    <div class="section full7" id="page-7" data-font-color="black">
      <div class="t-flex t-flex-col t-items-center t-justify-center f-main t-h-full">
        <div class="t-flex t-flex-col t-justify-center t-items-center t-gap-10">
          ...
          <a href="/new/fate/fate18.php?counselGbn=34645" class="t-flex t-justify-center t-items-center t-bg-red t-rounded-lg t-py-2 t-px-3 t-w-fit t-text-base xl:t-text-xl t-text-white" target="_blank">
            내게 맞는 커플매니저 찾기
          </a>
        </div>
    ...
    <div class="section full8" id="page-8" data-font-color="#fff">
      <content class="content8_Wrap t-flex t-flex-col xl:t-flex-row t-justify-center f-main t-gap-10 xl:t-gap-0 xl:t-w-11/12">
        <section class="content8_header t-w-full xl:t-w-3/12 t-text-3xl t-flex t-flex-col t-items-center t-justify-center xl:t-items-start">
          <img src="https://www.isoohyun.co.kr/new/image/new_main/sec8_emoji2.png" alt="" class="t-w-[80px] xl:t-w-[119px]">
          <h5>
            업계유일
          </h5>
          <div class="t-flex t-flex-col t-items-center xl:t-items-start">
            <h5 class="t-text-2xl xl:t-text-5xl t-font-bold">5성급 호텔 맞선</h5>
            <div class="line2 t-hidden xl:t-block"></div>
            <div class="t-text-2xl xl:t-text-3xl">
              노블레스 성혼 서비스
            </div>
          </div>
        </section>
        <section class="content8_artwrap t-w-full xl:t-w-9/12">
          <div class="artground t-grid t-grid-cols-3 t-gap-1 xl:t-gap-5">
            <div class="article t-object-cover">
              <img src="https://www.isoohyun.co.kr/new/image/new_main/hotel01.png" class="t-w-full" alt="">
              <div class="hotel t-flex t-flex-col t-justify-center t-items-center">
                <div class="textline"></div>
                <p class="t-text-xs t-font-bold xl:t-text-lg">노보텔 앰배서더 강남</p>
              </div>
            </div>
            <div class="article t-object-cover">
              ...
              <div class="hotel t-flex t-flex-col t-justify-center t-items-center">
                <div class="textline"></div>
                <p class="t-text-xs t-font-bold xl:t-text-lg">포포인츠 쉐라톤 강남</p>
              </div>
            </div>
            <div class="article t-object-cover">
              ...
              <div class="hotel t-flex t-flex-col t-justify-center t-items-center">
                <div class="textline"></div>
                <p class="t-text-xs t-font-bold xl:t-text-lg">여의도 메리어트</p>
              </div>
            </div>
            ...
            <div class="article t-object-cover">
              ...
              <div class="hotel t-flex t-flex-col t-justify-center t-items-center">
                <div class="textline"></div>
                <p class="t-text-xs t-font-bold xl:t-text-lg">더 플라자 호텔</p>
              </div>
            </div>
            <div class="article t-object-cover">
              <img src="https://www.isoohyun.co.kr/new/image/new_main/hotel05.png" class="t-w-full">
              <div class="hotel t-flex t-flex-col t-justify-center t-items-center">
                <a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=191" target="_blank">
                  <div class="textline"></div>
                  <p class="t-text-xs t-font-bold xl:t-text-lg">더보기</p>
                </a>
              </div>
            </div>
            <div class="article t-object-cover">
              ...
              <div class="hotel t-flex t-flex-col t-justify-center t-items-center">
                <div class="textline"></div>
                <p class="t-text-xs t-font-bold xl:t-text-lg">대구 메리어트</p>
              </div>
            </div>
            ...
            <div class="article t-object-cover">
              ...
              <div class="hotel t-flex t-flex-col t-justify-center t-items-center">
                <div class="textline"></div>
                <p class="t-text-xs t-font-bold xl:t-text-lg">오크우드 코엑스</p>
              </div>
            </div>
            <div class="article t-object-cover">
              ...
              <div class="hotel t-flex t-flex-col t-justify-center t-items-center">
                <div class="textline"></div>
                <p class="t-text-xs t-font-bold xl:t-text-lg">동대문 JW메리어트</p>
              </div>
            </div>
            <div class="article t-object-cover">
              <div class="textline"></div>
              ...
              <div class="hotel t-flex t-flex-col t-justify-center t-items-center">
                <div class="textline"></div>
                <p class="t-text-xs t-font-bold xl:t-text-lg">부산 롯데호텔</p>
              </div>
            </div>
          </div>
        </section>
...
<!--  9.안심서비스  -->
    <div class="section full9" id="page-9" data-font-color="black">
      <div class="t-flex t-flex-col t-justify-center t-items-center t-h-full f-main">
        <div class="t-flex t-flex-col t-justify-center t-items-center t-gap-10">
          <h5 class="t-text-xl xl:t-text-6xl t-text-black"><span class="t-font-bold">믿을 수 있는</span> 결혼정보회사</h5>
          <a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=94" class="t-flex t-justify-center t-items-center t-bg-red t-rounded-lg t-py-2 t-px-3 t-w-fit t-text-base xl:t-text-xl t-text-white" target="_blank">
        ...
        <div class="content2_artbox t-mt-5 t-border-t t-border-b t-border-gray-300 t-w-full">
          <div class="t-grid t-grid-cols-3 t-py-20">
    
            <div class="t-flex t-flex-col t-justify-center t-items-center t-gap-4">
              <img style="margin-left: 50px;margin-right: 50px;" src="https://www.isoohyun.co.kr/new/image/new_main/safe_01.png">
              <div class="t-text-2xl t-text-black t-py-8">공정거래<br>표준약관 적용</div>
              <div class="t-text-slate-800 t-text-lg">소비자 권익보호를 위해<br>표준약관 100% 준수</div>
            </div>
    
            <div class="t-flex t-flex-col t-justify-center t-items-center t-gap-4">
              <img style="margin-left: 50px;margin-right: 50px;" src="https://www.isoohyun.co.kr/new/image/new_main/safe_02.png">
              <div class="t-text-2xl t-text-black t-py-8">철저한 신원인증<br>신원정보 비밀보장</div>
              <div class="t-text-slate-800 t-text-lg">제 3자 위탁없이 100% 본사<br>신원인증팀이 인증 진행</div>
            </div>
            <div class="t-flex t-flex-col t-justify-center t-items-center t-gap-4">
              <img style="margin-left: 50px;margin-right: 50px;" src="https://www.isoohyun.co.kr/new/image/new_main/safe_03.png">
              <div class="t-text-2xl t-text-black t-py-8">커플매칭, 전문직배상<br>책임보험 가입</div>
              <div class="t-text-slate-800 t-text-lg">신원인증 프로세스 강화<br>피해보상 안전시스템 구축</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="t-flex t-flex-col t-items-center t-justify-between t-w-full">
            ...
            <div class="t-w-full t-flex t-flex-col t-justify-between t-gap-10 t-mt-10">
              ...
              <div class="t-flex md:t-flex-row t-flex-col t-w-full t-justify-center t-gap-2 t-z-[1]">
                <div class="t-flex t-items-center t-justify-between t-bg-[#ffadb3] t-p-[5px]">
                  <div class="t-flex t-items-center t-w-[320px] t-h-full">
                    <div class="t-flex t-flex-col t-text-white t-text-base md:t-text-2xl t-font-bold t-pl-2 t-pb-2">
                      <span>이달의</span>
                      <span>파티이벤트</span>
                    </div>
                    <a href="https://www.isoohyun.co.kr/new/meet/meet11.php" class="event2_btn t-mt-[25px] t-w-[72px] t-h-[39px] xl:t-mt-[25px] xl:t-w-[100px] xl:t-h-[55px]" target="_blank"></a>
                  </div>
                  <div>
                    <img style="" src="/uploads/contents_image/20220930111437.jpg" alt="" class="t-w-[125px] sm:t-w-[100%]" >
                  </div>
                </div>
                
                <div class="t-flex t-items-center t-justify-between t-bg-[#ffadb3] t-p-[5px]">
                  <div class="t-flex t-items-center t-w-[320px] t-h-full">
                    <div class="t-flex t-flex-col t-text-white t-text-base md:t-text-2xl t-font-bold t-pl-2">
                      <span>파티영상</span>
                      <span>& 갤러리</span>
                    </div>
                    <a href="https://www.isoohyun.co.kr/new/meet/meet11.php" class="event2_btn t-mt-[25px] t-w-[72px] t-h-[39px] xl:t-mt-[25px] xl:t-w-[100px] xl:t-h-[55px]" target="_blank"></a>
                  ...
                  <div>
                    <img style="" src="https://www.isoohyun.co.kr/new/image/new_main/culture_event/01.png" alt="" class="t-w-[125px] sm:t-w-[100%]" >
                  </div>
                </div>
          ...
          <div class="t-flex t-flex-col t-items-center t-w-full">
            <div class="t-relative t-flex t-flex-col t-w-full t-text-black">
              <div class="t-flex t-flex-col t-justify-center t-items-center">
                <h2 class="sm:t-text-6xl t-text-xl t-py-4 t-font-bold">LOVE TEST</h2>
                <h3 class="sm:t-text-xl t-text-sm t-text-gray-500 t-px-10">
                  <img src="/new/image/new_main/sec11_emoji.png" class="t-inline-block t-align-middle t-w-8 t-h-8">
                  <span class="t-align-middle t-ml-2">간단한 테스트를 통해 나의 이상형을 찾고 <span class="t-font-bold">추천프로필</span>을 받아보세요!</span>
                </h3>
                <a href="https://www.isoohyun.co.kr/new/lovetest/ideal_worldcup.php" target="_blank" class="t-text-gray-500 t-underline t-underline-offset-8 t-mt-2">더보기 &gt;</a>
              </div>
              <div class="t-flex t-flex-col t-items-center t-justify-center t-mt-20 md:t-px-[100px]">
                <div class="swiper mySwiper4">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <a href="https://www.isoohyun.co.kr/new/lovetest/ideal_find_test.php?counselGbn=34613">
                        <img class="img mo_none" src="https://www.isoohyun.co.kr/new/image/new_main/img_sect_collect1.png" alt="">
                      </a>
                    </div>
                    <div class="swiper-slide">
                      <a href="https://www.isoohyun.co.kr/new/lovetest/first_face_test.php?counselGbn=34614">
                        <img class="img mo_none" src="https://www.isoohyun.co.kr/new/image/new_main/img_sect_collect2.png" alt="">
                      </a>
                    </div>
                    <div class="swiper-slide">
                      <a href="https://www.isoohyun.co.kr/nm/html/lovetest/love_test2.php?counselGbn=34615">
                        <img class="img mo_none" src="https://www.isoohyun.co.kr/new/image/new_main/img_sect_collect3.png" alt="">
                      </a>
                    </div>
                    <div class="swiper-slide">
                      <a href="https://m.isoohyun.co.kr/nm/html/lovetest/knowledge.php?counselGbn=34616">
                        <img class="img mo_none" src="https://www.isoohyun.co.kr/new/image/new_main/img_sect_collect4.png" alt="">
                      </a>
                    </div>
                    <div class="swiper-slide">
                      <a href="https://www.isoohyun.co.kr/nm/html/lovetest/marry_step2.php?counselGbn=34617">
                        <img class="img mo_none" src="https://www.isoohyun.co.kr/new/image/new_main/img_sect_collect5.png" alt="">
                      </a>
                    </div>
                    <div class="swiper-slide">
                      <a href="https://www.isoohyun.co.kr/nm/html/lovetest/marryChance.php?counselGbn=34618">
                        <img class="img mo_none" src="https://www.isoohyun.co.kr/new/image/new_main/img_sect_collect6.png" alt="">
                      </a>
                    </div>
                    <div class="swiper-slide">
                      <a href="https://www.isoohyun.co.kr/new/lovetest/hope_ideal_test.php?counselGbn=34619">
    ...
    <div class="section full12 t-relative" id="page-12" data-font-color="#fff">
      <video id="page-12-video" poster="" loop autoplay muted data-keepplaying playsinline name="media">
        <source src="/new/image/new_main/bg_2.mp4" type="video/mp4"><source/>
      </video>
      ...
      <div class="t-absolute t-w-screen md:t-h-full text-base t-bottom-0 md:t-top-0 md:t-pt-[250px] md:t-px-[180px] f-main t-pb-[26px] sm:t-pb-[85px]">
        <div class="t-w-full t-h-full t-text-white t-flex t-flex-col t-justify-between t-opacity-75">
          <div class="t-flex t-flex-col t-ml-1 md:t-ml-0 t-w-[350px] t-h-[175px] md:t-h-[350px] t-text-white">
            <h5 class="t-text-xl md:t-text-4xl t-font-bold">노블레스 수현<br></h5>
            <h5 class="t-text-3xl md:t-text-6xl t-font-bold t-text-[#ed2024]">YOUTUBE</h5>
            <div class="t-text-base t-mt-6">수현의 다양하고 재미있는 영상컨텐츠를 즐겨주세요</div>
          ...
          <div class="t-mb-10">
            <div class="swiper mySwiper5">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <iframe width="100%" height="100%" src="https://www.youtube.com/embed/LEPFXbQ6Fso?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                </div>
                <div class="swiper-slide">
                  <iframe width="100%" height="100%" src="https://www.youtube.com/embed/7zZnHXAE73Y?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                </div>
                <div class="swiper-slide">
                  <iframe width="100%" height="100%" src="https://www.youtube.com/embed/qeBmJiqmOZ0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                </div>
                <div class="swiper-slide">
                  <iframe width="100%" height="100%" src="https://www.youtube.com/embed/XpnQal1u8gs?rel=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                </div>
              </div>
              <div class="swiper-pagination"></div>
            </div>
      ...
      <div class="t-flex t-flex-col t-items-center t-justify-center t-relative t-w-full t-h-full">
        <div class="t-relative t-flex t-flex-col xl:t-flex-row t-w-full t-h-full t-text-white t-h-full">
          <div class="t-flex t-flex-col t-justify-center t-items-center t-w-full xl:t-w-4/12 t-relative t-bg-c1 t-h-80 xl:t-h-full">
            <h2 class="t-flex t-flex-col t-justify-start sm:t-text-5xl t-text-xl t-font-bold">
              <span class="t-pb-6"><span class="t-text-cg">수상경력</span></span>
              <span class="t-text-xl">노블레스 수현은 국가와 신뢰</span>
              <span class="t-text-xl">받는 주요 평가 매체에서 인정 받고 있습니다.</span>
              <a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=192" target="_blank" class="t-text-xl t-text-white t-underline t-underline-offset-8 t-mt-10">수상경력 더보기 &gt;</a>
            </h2>
          </div>
          ...
          <div class="t-flex t-flex-col t-items-start sm:t-items-center t-justify-center xl:t-w-8/12 t-flex-1 f-main">
            <div class="t-w-full">
              <div class="swiper mySwiper6">
                <div class="swiper-wrapper">
                  <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=154"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards1.png" /></a></div>
                  <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=168"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards2.png" /></a></div>
                  <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=180"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards3.png" /></a></div>
                  <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=186"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards4.png" /></a></div>
                  <div class="swiper-slide"><a href="http://m.isoohyun.co.kr/nm/html/introduce/notice-view.php?idx=175"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards5.png" /></a></div>
                  <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=164"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards6.png" /></a></div>
                  <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=179"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards7.png" /></a></div>
                  <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=177"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards8.png" /></a></div>
                  <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=169"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards9.png" /></a></div>
                  <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=180"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards10.png" /></a></div>
                  <div class="swiper-slide"><a href="http://m.isoohyun.co.kr/nm/html/introduce/notice-view.php?idx=190"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards11.png" /></a></div>
                  <div class="swiper-slide"><a href="http://m.isoohyun.co.kr/nm/html/introduce/news-view.php?idx=362"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards12.png" /></a></div>
                  <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=104"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards13.png" /></a></div>
                  <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/about/about08.php?idx=195"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/awards14.png" /></a></div>
                </div>
                <div class="swiper-pagination"></div>
              </div>
            </div>
    ...
    <div class="section full14" id="page-14" data-font-color="black">
      <div class="t-flex t-flex-col t-justify-between xl:t-px-20 t-items-center f-main">
        <div class="t-flex t-flex-col t-justify-center t-items-center">
          <h2 class="sm:t-text-6xl t-text-xl t-py-4 t-font-bold">수현 제휴 네트워크</h2>
          <h3 class="sm:t-text-xl t-text-sm t-text-gray-500 t-px-10">
        ...
        <div class="t-flex t-flex-col t-items-center t-justify-center t-w-10/12 xl:t-w-9/12 t-mt-10">
          <div class="t-w-full">
            <div class="swiper mySwiper7" style="padding: 0 !important">
              <div class="swiper-wrapper">
                <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/benefit/benefit08_t.php"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/identification01.png" /></a></div>
                <div class="swiper-slide"><a href="https://www.isoohyun.co.kr/new/benefit/benefit08_t.php"><img style="" src="https://www.isoohyun.co.kr/new/image/new_main/identification02.png" /></a></div>
              </div>
            </div>
          </div>
          <img style="" src="https://www.isoohyun.co.kr/new/image/new_main/identification03.png" class="t-mt-5" />

          <div class="t-flex t-flex-col t-justify-center t-mt-4 sm:t-text-[1.12rem] t-leading-[1.15rem] t-text-base t-font-[400]">
            <div>노블레스 수현은 현대이지웰과 독점 제휴를 통해 정부부처, 공공기관 국내주요 대기업 및 중견기업에 결혼정보서비스를 제공하고 있습니다.</div>
          </div>
        </div>
    ...
    <div class="section full15" id="page-15" data-font-color="black">
      <div class="t-flex t-flex-col t-justify-center t-items-center t-h-full f-main t-pb-[26px] sm:t-pb-[85px]">
        <div class="t-flex t-flex-col t-justify-center t-items-center t-w-full t-relative t-gap-10">
          <h5 class="t-text-xl xl:t-text-6xl t-text-black">노블레스 수현 지사</h5>
          <a href="https://www.isoohyun.co.kr/new/fate/fate18.php" class="t-flex t-justify-center t-items-center t-bg-red t-rounded-lg t-py-2 t-px-3 t-w-fit t-text-base xl:t-text-xl t-text-white" target="_blank">
            상담은 가까운 곳에서, 만남은 전국 회원 대상으로 진행됩니다!
          </a>
        </div>
          
        <div class="xl:t-w-full t-w-[370px] t-h-[375px] sm:t-h-[400px] t-mt-10 sm:t-mt-20">
          <div class="t-flex t-flex-col xl:t-grid xl:t-grid-cols-2 xl:t-px-20 t-h-full xl:t-h-[347px]">
            <div class="t-flex-col t-justify-center t-items-center t-flex">
              <div class="t-flex t-flex-col t-items-start t-justify-between t-w-full t-h-full">
                <div class="t-w-full t-h-full t-grid t-grid-cols-4">
                  <div class="t-flex t-justify-center t-items-center t-text-sm t-py-2 t-text-white hover:t-bg-cg t-bg-cg t-cursor-pointer page-15-tab" data-img="seoul_building" data-map="https://www.isoohyun.co.kr/new/about/map3.php">서울본사</div>
                  <div class="t-flex t-justify-center t-items-center t-text-sm t-border-l t-border-gray-600 t-py-22 t-bg-[#505050] t-text-white hover:t-bg-cg t-cursor-pointer page-15-tab" data-img="busan_building" data-map="https://www.isoohyun.co.kr/new/about/map8.php">부산지사</div>
                  <div class="t-flex t-justify-center t-items-center t-text-sm t-border-l t-border-gray-600 t-py-22 t-bg-[#505050] t-text-white hover:t-bg-cg t-cursor-pointer page-15-tab" data-img="daegu_building" data-map="https://www.isoohyun.co.kr/new/about/map9.php">대구지사</div>
                  <div class="t-flex t-justify-center t-items-center t-text-sm t-border-l t-border-gray-600 t-py-22 t-bg-[#505050] t-text-white hover:t-bg-cg t-cursor-pointer page-15-tab" data-img="daejeon_building" data-map="https://www.isoohyun.co.kr/new/about/map10.php">대전지사</div>
                </div>


                <img class="t-w-full t-hidden xl:t-block page-15-img" src="https://www.isoohyun.co.kr/new/image/new_main/seoul_building.jpg">
              </div>
            </div>

            <div class="t-flex-1 t-flex t-flex-col t-justify-center t-items-center t-border-2 t-border-gray-300">
      ...
      <script>
        $(document).ready(function() {
          $('.page-15-tab').click(function() {
            $('.page-15-tab').removeClass('t-bg-cg');
            $('.page-15-tab').addClass('t-bg-[#505050]');

            $(this).removeClass('t-bg-[#505050]');
            $(this).addClass('t-bg-cg');
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#fullpage').fullpage({
			navigation: true,
      dragAndMove: true,
			navigationTooltips: ['수현','회원수', '서비스', '성혼율', '매칭후기', '회원현황', '매니저', '맞선장소', '안심서비스', '파티&이벤트', '러브테스트', '유튜브', '수상경력', '제휴사', '지사', '약관'],
			navigationPosition: 'right',
      onLeave: function(index, nextIndex, direction){
        var fColor = $('#page-' + nextIndex).data('font-color');

        $('#fp-nav ul li .fp-tooltip.right').css('color', fColor);
        if(fColor === 'black') {
          $('header').css('background', '#00000036');
        } else {
        ...
        if(nextIndex == 10){
          ...
          $({
            ...
            duration: 3000,
            step: function() {
              var num = numberWithCommas(Math.floor(this.val * 10) / 10);
              $(".page-4-1").text(num + '%');
            },
            complete: function() {
              var num = numberWithCommas(Math.floor(this.val * 10) / 10);
      ...
      afterLoad: function(Link, index) {
        $(document).find('#fp-nav ul li').find('.fp-tooltip').eq((index-1)).addClass('active');
      }

    });

    $('.fp-tooltip').removeClass('active');
    $('.fp-tooltip').eq(0).addClass('active');
        //methods
  });
</script>
