...
<script type="text/javascript" src="/new/js/frontPaging.js"></script>
  ...
  <script>
    ...
    if (window.innerWidth < 780) {
      //Your Code
      window.location.href = 'https://www.isoohyun.co.kr/nm/html/lovetest/join_test.php?counselGbn=28862&mctkey=';
    }
  </script>
  ...
  <script>
    ...
    function changecolor1() {
      ...
      $(".new_birthday").css("border", "3px solid  #ccae70");
    ...
    function changecolor2() {
      ...
      $(".school").css("border", "3px solid  #ccae70");
...
<!-- End Channel Plugin -->    <!DOCTYPE html>
  ...
  <div id="floating_open">
    ...
    <ul class="main_menu_list">
      <li><a href="/new/lovetest/ideal_find_test.php">이상형찾기</a></li>
      <li><a href="/new/lovetest/ideal_worldcup.php">이상형 월드컵</a></li>
      ...
      <li class="on"><a href="/new/lovetest/join_test.php">노블레스가입비 TEST</a></li>
      ...
      <div class="wrap" style="max-width:1920px; margin:auto;">
        ...
        <section id="lovetest">
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/pc/index_bg.png'); height:600px; background-repeat: no-repeat; background-position:center;position: relative;">
              <a href="javascript:show(1);"><img style="position: absolute;top:470px;left:50%;transform: translate(-50%, -50%);" src="/new/image/pc/index_btn.png" alt="" /></a>
            </div>
          </div>
        </section>
        ...
        <section id="lovetest">
          <form id="frm" name="frm" method="post">
            <input type="hidden" name="counselGbn" value="28862" />
            ...
            <!-- show(1) -->
            <div class="join-charge">
              <div style="background-image: url('/new/image/pc/p_q_bg01.png'); height:600px;">
                <div class="input-box">
                ...
                <center>
                  ...
                  <img type="button" style="cursor: pointer; width:420px;" onclick="show(2);return false;" src="/new/image/pc/btn_next.png" alt="">
                </center>
        ...
        <section id="lovetest">
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/pc/p_q_bg01.png'); height:600px;">
              ...
              <!-- 이전페이지, 다음페이지 -->
              <div style="margin-left:280px; display:block; margin-top:-543px;">
                <img style="cursor: pointer;" src="/new/image/pc/btn_prev.png" alt="" onclick="show(1);return false;" />
              </div>
              <!-- 이전페이지, 다음페이지 -->
            </div>
          </div>
          ...
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/pc/p_q_bg01.png'); height:600px;">
              <div class="container" style="width: 400px; padding-top:70px;">
                ...
                <img class="progress-bar2" src=""></img>
                <div class="progress border">
                  <div class="progress-bar progress-bar-striped progress-bar-animated" style="background-color:#ccae70" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div>
              ...
              <center>
                <ul class="radio-box">
                  ...
                  <li class="list_box" onclick="show(4,'전문대졸업');">전문대졸업</li>
                </ul>
                <ul class="radio-box">
                  <li class="list_box" onclick="show(4,'대졸이상');">대학교(4년제)졸업</li>&nbsp;&nbsp;
              ...
              <div style="margin-left:280px; display:block; margin-top:-447px;">
                <img style="cursor: pointer;" src="/new/image/pc/btn_prev.png" alt="" onclick="show(2);return false;" />
              </div>
              <!-- 이전페이지, 다음페이지 -->
            </div>
          </div>
          ...
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/pc/p_q_bg01.png'); height:600px;">
              ...
              <center>
                ...
                <ul class="radio-box">
                  <li class="list_box list_one" onclick="show(5,'1억이상');">1억이상</li>&nbsp;&nbsp;
                </ul>
              </center>
              <!-- 이전페이지, 다음페이지 -->
              <div style="margin-left:280px; display:block; margin-top:-447px;">
                <img style="cursor: pointer;" src="/new/image/pc/btn_prev.png" alt="" onclick="show(3);return false;" />
              </div>
              <!-- 이전페이지, 다음페이지 -->
            </div>
          </div>
        ...
        <section id="lovetest">
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/pc/p_q_bg01.png'); height:600px;">
              ...
              <!-- 이전페이지, 다음페이지 -->
              <div style="margin-left:280px; display:block; margin-top:-543px;">
                <img style="cursor: pointer;" src="/new/image/pc/btn_prev.png" alt="" onclick="show(4);return false;" />
              </div>
              <!-- 이전페이지, 다음페이지 -->
            </div>
          </div>
        ...
        <section id="lovetest">
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/pc/p_q_bg01.png'); height:600px;">
              ...
              <!-- 이전페이지, 다음페이지 -->
              <div style="margin-left:280px; display:block; margin-top:-447px;">
                <img style="cursor: pointer;" src="/new/image/pc/btn_prev.png" alt="" onclick="show(5);return false;" />
              </div>
              <!-- 이전페이지, 다음페이지 -->
            </div>
          </div>
        ...
        <section id="lovetest">
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/pc/p_q_bg02.png'); height:600px;">

              <div>
                <img style="margin-left:750px; width:20%; height:80px; margin-top:480px; cursor:pointer;" src="/new/image/pc/btn_kakao.png" alt="" onclick="javascript:kakaoGetData();" />
              </div>
              <!-- 이전페이지, 다음페이지 -->
              <div style="margin-left:280px; display:block; margin-top:-516px;">
                <img style="cursor: pointer;" src="/new/image/pc/btn_prev.png" alt="" onclick="show(6);return false;" />
              </div>
              <!-- 이전페이지, 다음페이지 -->
            </div>
          </div>
        ...
        <section id="lovetest">
          <div class="join-charge">
            <div class="" style="background-image: url('/new/image/pc/p_result_bg.png'); height:600px;">
              <div class="textbox">
                <p class="top">
                  <span id="names" style="border-bottom:1px solid #ffe182"></span>님의 가입비 산출이 완료되었습니다.
                </p>
                <p class="bottom" style="margin-top:-70px">
                  고객님의 가입비를 산출하는데 매칭 정보가 정상적으로 등록되었으며<br>
                  입력하신 <span id="emails" style="border-bottom:1px solid #ffe182"></span>(으)로 결과가 7일내에 발송됩니다.
                </p>
                <p class="bottom" style="margin-top:20px">
                  더 빠른 상담을 원하시면 <span style="color:#ffe182;font-weight:bold;">무료상담전화 02-540-4000</span>으로 문의주시길 바랍니다.<br>
                  언제나 친절히 상담해 드리겠습니다.
                </p>
              </div>
              <div style="display:block; margin-left:280px; margin-top:-500px; cursor:pointer;">
                <img style="cursor: pointer;" src="/new/image/pc/btn_re.png" alt="" onclick="location.reload();" />
              </div>
            </div>
          </div>
        </section>
