...
<!-- End Channel Plugin -->  <!-- 웹으로 모바일 페이지 보면 리다이렉트 -->
  <script>
    ...
    if (window.innerWidth > 780) {
      window.location.href = 'https://www.isoohyun.co.kr/new/lovetest/hope_ideal_test.php?counselGbn=29813&mctkey=&src=image&kw=00007C&pv_imp_id=${IMP_ID}&adpk_action=%adpk_action%';
    }
  </script>
  ...
  <script>
    ...
    function changecolor1() {
      ...
      $("#new_birthday").css("border", "1px solid #bea392");
    ...
    function changecolor2() {
      ...
      $("#school").css("border", "1px solid #bea392");
  ...
  <h2 class="title" style="padding-left: 50px;">
    ...
    <section id="lovetest">
      <div class="join-charge">
        <div class="" style="background-image: url('../../static/images/lovetest/hope_ideal_mobile/mainimg.jpg'); height:680px;background-repeat: no-repeat; background-position:top;background-size:cover;">
          <p class="btn" style="height: 26px;"><a href="javascript:show(1);"><img style="width: 83%;" src="../../static/images/lovetest/hope_ideal_mobile/m_start_btn.png" alt="" /></a></p>
        </div>
      </div>
    </section>
    ...
    <section id="lovetest">
      <form id="frm" name="frm" method="post">
        <input type="hidden" name="counselGbn" value="29813" />
        <input type="hidden" name="counselGbn2" value="희망상대 프로필 추천_m" />
        ...
        <!-- show(1) -->
        <div class="join-charge">
          <div style="background-image: url('../../static/images/lovetest/hope_ideal_mobile/section_bg.png'); height:700px;position: relative; background-repeat: no-repeat; background-position:top;background-size:cover;">
            <div class="input-box">

              <div style="margin-left:20px; padding-top:30px;">
                <img style="cursor: pointer;position: absolute;top:0;margin-top:25px;" src="../../static/images/lovetest/hope_ideal_mobile/m_btn_prev.png" alt="" onclick="show(0);return false;" />
              </div>
              ...
              <center>
                <img style="cursor: pointer;width: 310px;margin-top:-10px; padding-top:18px;" src="../../static/images/lovetest/hope_ideal_mobile/m_btn_next.png" alt="" style="width: 82%; text-align:center; margin-top:10px;" onclick="show(2);return false;" />
              </center>
            </div>
          </div>
        </div>
    ...
    <section id="lovetest">
      <div class="join-charge">
        <div style="background-image: url('../../static/images/lovetest/hope_ideal_mobile/section_bg.png'); height:700px; background-repeat: no-repeat; background-position:top;background-size:cover;">
          <div style="margin-left:20px; padding-top:25px;">
            <img style="cursor: pointer;" src="../../static/images/lovetest/hope_ideal_mobile/m_btn_prev.png" alt="" onclick="show(1);return false;" />
          </div>
    ...
    <section id="lovetest">
      <div class="join-charge">
        <div style="background-image: url('../../static/images/lovetest/hope_ideal_mobile/section_bg.png'); height:700px; background-repeat: no-repeat; background-position:top;background-size:cover;">
          <div style="margin-left:20px; padding-top:25px;">
            <img style="cursor: pointer;" src="../../static/images/lovetest/hope_ideal_mobile/m_btn_prev.png" alt="" onclick="show(2);return false;" />
          </div>
          <div class="container" style="width: 300px; padding-top:10px;">
    ...
    <section id="lovetest">
      <div class="join-charge">
        <div style="background-image: url('../../static/images/lovetest/hope_ideal_mobile/section_bg.png'); height:700px; background-repeat: no-repeat; background-position:top;background-size:cover;">
          <div style="margin-left:20px; padding-top:25px;">
            <img style="cursor: pointer;" src="../../static/images/lovetest/hope_ideal_mobile/m_btn_prev.png" alt="" onclick="show(3);return false;" />
          </div>
          <div class="container" style="width: 300px; padding-top:10px;">
    ...
    <section id="lovetest">
      <div class="join-charge">
        <div style="background-image: url('../../static/images/lovetest/hope_ideal_mobile/section_bg.png'); height:700px; background-repeat: no-repeat; background-position:top;background-size:cover;">
          <div style="margin-left:20px; padding-top:25px;">
            <img style="cursor: pointer;" src="../../static/images/lovetest/hope_ideal_mobile/m_btn_prev.png" alt="" onclick="show(4);return false;" />
          </div>
          <div class="container" style="width: 300px; padding-top:10px;">
    ...
    <section id="lovetest">
      <div class="join-charge">
        <div style="background-image: url('../../static/images/lovetest/hope_ideal_mobile/section_bg.png'); height:700px; background-repeat: no-repeat;background-position:top;background-size:cover;">
          <div style="margin-left:20px; padding-top:25px;">
            <img style="cursor: pointer;" src="../../static/images/lovetest/hope_ideal_mobile/m_btn_prev.png" alt="" onclick="show(5);return false;" />
          </div>
          <div class="container" style="width: 300px; padding-top:10px;">
    ...
    <section id="lovetest">
      <div class="join-charge">
        <div style="background-image: url('../../static/images/lovetest/hope_ideal_mobile/section_bg.png'); height:700px; background-repeat: no-repeat;background-position:top;background-size:cover;">
          <div style="margin-left:20px; padding-top:25px;">
            <img style="cursor: pointer;" src="../../static/images/lovetest/hope_ideal_mobile/m_btn_prev.png" alt="" onclick="show(6);return false;" />
          </div>
          <div class="container" style="width: 300px; padding-top:10px;">
          ...
          <center>
            ...
            <ul class="radio-box">
              ...
              <li class="list_box" style="line-height: 30px;" onclick="show(8,'예능계,프리랜서,서비스');">예능계,프리랜서,<br>서비스</li>
            </ul>
            <ul class="radio-box">
    ...
    <section id="lovetest">
      <div class="join-charge">
        <div style="background-image: url('../../static/images/lovetest/hope_ideal_mobile/section_bg.png'); height:700px; background-repeat: no-repeat; background-position:top;background-size:cover;">
          <div style="margin-left:20px; padding-top:25px;">
            <img style="cursor: pointer;" src="../../static/images/lovetest/hope_ideal_mobile/m_btn_prev.png" alt="" onclick="show(7);return false;" />
          </div>
          <div class="container" style="width: 300px; padding-top:10px;">
            <span style="color:#7a5942;margin-bottom:-20px;">7/7</span>
            <!-- <img class="progress-bar2" src=""></img> -->
            <div class="progress border">
              <div class="progress-bar progress-bar-striped progress-bar-animated" style="background-color:#7a5942" role="progressbar" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
    ...
    <section id="lovetest" class="loading_page">
      <div class="join-charge">
        <div style="background-image: url('../../static/images/lovetest/hope_ideal_mobile/b_bg.png'); height:700px; background-repeat: no-repeat; background-position:top;background-size:cover;">
          <div style=" padding-top:50px;">
            <!-- <img  style="cursor: pointer;"  src="../../static/images/lovetest/hope_ideal_mobile/loading_gif.gif" alt="" onclick="show(0);return false;" /> -->
            ...
            <div class="lds-spinner" onclick="show(10);return false;">
              ...
              <div></div>
              <div></div>
              <p class="loader fz18"></p>
            </div>
            <p class="loader fz24">결과를 확인 중입니다.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="lovetest" class="result_page">
      <div class="join-charge">
        <div style="background-image: url('../../static/images/lovetest/hope_ideal_mobile/success1_bg.png'); height:700px; background-repeat: no-repeat; background-position:top;background-size:cover;">
          <div style=" padding-top:30px;">
            <img style="margin-left:20px;" src="../../static/images/lovetest/hope_ideal_mobile/m_btn_prev.png" alt="" onclick="show(8);return false;" />
            <!-- <div class="textbox">
              <p>
                <span id="names">당신의</span><br>희망조건에 맞는<br>
                <b>프로필 추천이 완료</b><span>되었습니다.</span>
              </p>
            </div> -->
            <center>
              <div style="margin-top:340px;">
                <img id="kakao_success" style="cursor: pointer;" style="width: 300px;" src="../../static/images/lovetest/hope_ideal_mobile/btn_kakao.png" alt="" onclick="javascript:success();" />
              </div>
            </center>
          </div>
        </div>
    ...
    <!-- show(9) kakao section -->
    <section id="lovetest" class="result_page">
      <div class="join-charge">
        <div style="background-image: url('../../static/images/lovetest/hope_ideal_mobile/last_bg.png'); height:600px; background-repeat: no-repeat; background-position:top;background-size:cover">
          <div style=" padding-top:340px;">
            <center>
              <img style="cursor: pointer;border:1px solid #7a5942;" src="../../static/images/lovetest/hope_ideal_mobile/m_btn_re.png" alt="" onclick="window.location.reload();" />
            </center>
